...
const Waypoint = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${escape(null_to_empty(`wrapper ${c}`)) + " svelte-142y8oi"}"${add_attribute("style", style, 0)}>
  ${visible
...
/* node_modules/svelte-image/src/Image.svelte generated by Svelte v3.16.0 */

const css$1 = {
	code: "img.svelte-373mer{object-position:center;position:absolute;top:0;left:0;width:100%;will-change:opacity}.blur.svelte-373mer{filter:blur(10px);transition:opacity 0.4s ease, filter 0.5s ease}.placeholder.svelte-373mer{opacity:1;transition:opacity 0.5s ease;transition-delay:0.7s}.main.svelte-373mer{opacity:0;transition:opacity 0.5s ease;transition-delay:0.7s}.loaded.svelte-373mer .placeholder.svelte-373mer{opacity:0}.loaded.svelte-373mer .main.svelte-373mer{opacity:1}",
	map: "{\"version\":3,\"file\":\"Image.svelte\",\"sources\":[\"Image.svelte\"],\"sourcesContent\":[\"<script>\\n  import Waypoint from \\\"svelte-waypoint\\\";\\n\\n  export let c = \\\"\\\";\\n\\n  export let alt = \\\"\\\";\\n  export let width = \\\"\\\";\\n  export let height = \\\"\\\";\\n  export let src = \\\"\\\";\\n  export let srcset = \\\"\\\";\\n  export let srcsetWebp = \\\"\\\";\\n  export let ratio = \\\"100%\\\";\\n  export let blur = false;\\n  export let sizes = \\\"(max-width: 1000px) 100vw, 1000px\\\";\\n\\n  let loaded = false;\\n\\n  function load(img) {\\n    img.onload = () => loaded = true;\\n  }\\n</script>\\n\\n<style>\\n  img {\\n    object-position: center;\\n    position: absolute;\\n    top: 0;\\n    left: 0;\\n    width: 100%;\\n    will-change: opacity;\\n  }\\n\\n  .blur {\\n    filter: blur(10px);\\n    transition: opacity 0.4s ease, filter 0.5s ease;\\n  }\\n\\n  .placeholder {\\n    opacity: 1;\\n    transition: opacity 0.5s ease;\\n    transition-delay: 0.7s;\\n  }\\n   .main {\\n    opacity: 0;\\n    transition: opacity 0.5s ease;\\n    transition-delay: 0.7s;\\n  }\\n\\n  .loaded .placeholder {\\n    opacity: 0;\\n  }\\n  .loaded .main {\\n    opacity: 1;\\n  }\\n</style>\\n\\n<Waypoint\\n  style=\\\"min-height: 100px; width: 100%\\\"\\n  once\\n  threshold={1.0}>\\n  <div class:loaded style=\\\"position: relative; width: 100%;\\\">\\n    <div style=\\\"position: relative; overflow: hidden\\\">\\n      <div style=\\\"width:100%;padding-bottom:{ratio};\\\" />\\n      <img\\n        class=\\\"placeholder\\\"\\n        {src}\\n        {alt}\\n      >\\n      <picture>\\n        <source type=\\\"image/webp\\\" srcset={srcsetWebp}>\\n        <source srcset={srcset}>\\n        <img\\n          use:load\\n          class=\\\"main {c}\\\"\\n          class:blur\\n          {alt}\\n          {srcset}\\n          {width}\\n          {height}\\n          {sizes}\\n        >\\n    </picture>\\n    </div>\\n  </div>\\n</Waypoint>\"],\"names\":[],\"mappings\":\"AAuBE,GAAG,cAAC,CAAC,AACH,eAAe,CAAE,MAAM,CACvB,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,WAAW,CAAE,OAAO,AACtB,CAAC,AAED,KAAK,cAAC,CAAC,AACL,MAAM,CAAE,KAAK,IAAI,CAAC,CAClB,UAAU,CAAE,OAAO,CAAC,IAAI,CAAC,IAAI,CAAC,CAAC,MAAM,CAAC,IAAI,CAAC,IAAI,AACjD,CAAC,AAED,YAAY,cAAC,CAAC,AACZ,OAAO,CAAE,CAAC,CACV,UAAU,CAAE,OAAO,CAAC,IAAI,CAAC,IAAI,CAC7B,gBAAgB,CAAE,IAAI,AACxB,CAAC,AACA,KAAK,cAAC,CAAC,AACN,OAAO,CAAE,CAAC,CACV,UAAU,CAAE,OAAO,CAAC,IAAI,CAAC,IAAI,CAC7B,gBAAgB,CAAE,IAAI,AACxB,CAAC,AAED,qBAAO,CAAC,YAAY,cAAC,CAAC,AACpB,OAAO,CAAE,CAAC,AACZ,CAAC,AACD,qBAAO,CAAC,KAAK,cAAC,CAAC,AACb,OAAO,CAAE,CAAC,AACZ,CAAC\"}"
};
...
const Image = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Waypoint, "Waypoint").$$render(
		...
		{
			default: () => `
  <div style="${"position: relative; width: 100%;"}" class="${["svelte-373mer", loaded ? "loaded" : ""].join(" ").trim()}">
    <div style="${"position: relative; overflow: hidden"}">
      <div style="${"width:100%;padding-bottom:" + escape(ratio) + ";"}"></div>
      <img class="${"placeholder svelte-373mer"}"${add_attribute("src", src, 0)}${add_attribute("alt", alt, 0)}>
      <picture>
        <source type="${"image/webp"}"${add_attribute("srcset", srcsetWebp, 0)}>
        <source${add_attribute("srcset", srcset, 0)}>
        <img class="${["main " + escape(c) + " svelte-373mer", blur ? "blur" : ""].join(" ").trim()}"${add_attribute("alt", alt, 0)}${add_attribute("srcset", srcset, 0)}${add_attribute("width", width, 0)}${add_attribute("height", height, 0)}${add_attribute("sizes", sizes, 0)}>
    </picture>
    </div>
  </div>
`
...
const css$2 = {
	code: ".Row.svelte-9fdged{display:flex}",
	map: "{\"version\":3,\"file\":\"Row.svelte\",\"sources\":[\"Row.svelte\"],\"sourcesContent\":[\"<style>\\n  .Row {\\n    display: flex;\\n  }\\n</style>\\n\\n<div class=\\\"Row\\\">\\n  <slot />\\n</div>\\n\"],\"names\":[],\"mappings\":\"AACE,IAAI,cAAC,CAAC,AACJ,OAAO,CAAE,IAAI,AACf,CAAC\"}"
};

const Row = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$2);

	return `<div class="${"Row svelte-9fdged"}">
  ${$$slots.default ? $$slots.default({}) : ``}
</div>`;
});
...
const css$3 = {
	code: "h1.svelte-1vicqa7,p.svelte-1vicqa7{text-align:center;margin:0 auto}h1.svelte-1vicqa7{font-size:2.8em;text-transform:uppercase;font-weight:700;margin:0 0 0.5em 0}p.svelte-1vicqa7{margin:1em auto}@media(min-width: 480px){h1.svelte-1vicqa7{font-size:9.375em}}h1.svelte-1vicqa7{background-image:linear-gradient(180deg, #5b5cf1, #21b3ff);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<script>\\n  import Image from \\\"svelte-image\\\";\\n  import Row from \\\"../components/Row.svelte\\\";\\n</script>\\n\\n<style>\\n  h1,\\n  figure,\\n  p {\\n    text-align: center;\\n    margin: 0 auto;\\n  }\\n\\n  h1 {\\n    font-size: 2.8em;\\n    text-transform: uppercase;\\n    font-weight: 700;\\n    margin: 0 0 0.5em 0;\\n  }\\n\\n  figure {\\n    margin: 0 0 1em 0;\\n  }\\n\\n  img {\\n    width: 100%;\\n    max-width: 400px;\\n    margin: 0 0 1em 0;\\n  }\\n\\n  p {\\n    margin: 1em auto;\\n  }\\n\\n  @media (min-width: 480px) {\\n    h1 {\\n      font-size: 9.375em;\\n    }\\n  }\\n\\n  h1 {\\n    background-image: linear-gradient(180deg, #5b5cf1, #21b3ff);\\n    -webkit-background-clip: text;\\n    background-clip: text;\\n    -webkit-text-fill-color: transparent;\\n  }\\n</style>\\n\\n<svelte:head>\\n  <title>Sapper project template</title>\\n</svelte:head>\\n<Row>\\n  <h1>\\n    Develo-\\n    <br />\\n    per\\n  </h1>\\n\\n  <Image src=\\\"mo.jpg\\\" />\\n</Row>\\n\\n<p>\\n  Welcome to my portfolio. My name is Mohammed, but please call me Mo. On this\\n  site, you can see some of my work.\\n</p>\\n\\n<main>\\n  <section>\\n    <ul>\\n      <li>test</li>\\n    </ul>\\n  </section>\\n</main>\\n\"],\"names\":[],\"mappings\":\"AAME,iBAAE,CAEF,CAAC,eAAC,CAAC,AACD,UAAU,CAAE,MAAM,CAClB,MAAM,CAAE,CAAC,CAAC,IAAI,AAChB,CAAC,AAED,EAAE,eAAC,CAAC,AACF,SAAS,CAAE,KAAK,CAChB,cAAc,CAAE,SAAS,CACzB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,AACrB,CAAC,AAYD,CAAC,eAAC,CAAC,AACD,MAAM,CAAE,GAAG,CAAC,IAAI,AAClB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,EAAE,eAAC,CAAC,AACF,SAAS,CAAE,OAAO,AACpB,CAAC,AACH,CAAC,AAED,EAAE,eAAC,CAAC,AACF,gBAAgB,CAAE,gBAAgB,MAAM,CAAC,CAAC,OAAO,CAAC,CAAC,OAAO,CAAC,CAC3D,uBAAuB,CAAE,IAAI,CAC7B,eAAe,CAAE,IAAI,CACrB,uBAAuB,CAAE,WAAW,AACtC,CAAC\"}"
};
...
${validate_component(Row, "Row").$$render($$result, {}, {}, {
		default: () => `
  <h1 class="${"svelte-1vicqa7"}">
    Develo-
    <br>
    per
  </h1>

  ${validate_component(Image, "Image").$$render($$result, { src: "mo.jpg" }, {}, {})}
`
	})}

<p class="${"svelte-1vicqa7"}">
  Welcome to my portfolio. My name is Mohammed, but please call me Mo. On this
  site, you can see some of my work.
</p>
