...
<header class="${"h-full svelte-k9legf"}"><a href="${"/"}" class="${"logo_container px-10 mt-10 svelte-k9legf"}"><img src="${"mo_logo.svg"}" alt="${"logo from moniac"}" class="${"svelte-k9legf"}">
    <aside class="${"text-white pl-4 svelte-k9legf"}"><h1 class="${"svelte-k9legf"}">Mohammed Mulazada</h1>
      <h2 class="${"svelte-k9legf"}">Front-end Developer</h2></aside></a>

  <div class="${"header-holder svelte-k9legf"}"><div class="${"px-10 intro text-white svelte-k9legf"}"><h1 class="${"text-4xl leading-none mb-4 svelte-k9legf"}"><span class="${"font-bold text-6xl svelte-k9legf"}">Welcome</span>
        <br class="${"svelte-k9legf"}">
        to my portfolio
      </h1>
      <p class="${"max-w-lg svelte-k9legf"}">I am Mohammed Mulazada, a Front-End Developer based in Amsterdam. With a
        passion for all things web, I am looking for challenges and new things
        to learn each and every day.
      </p></div>

    <div class="${"figure-holder svelte-k9legf"}"><figure class="${"square svelte-k9legf"}"></figure>
      <figure class="${"triangle svelte-k9legf"}"><img alt="${""}" src="${"./triangle.svg"}" class="${"svelte-k9legf"}"></figure>
      <figure class="${"polygon svelte-k9legf"}"><img alt="${""}" src="${"./polygon.svg"}" class="${"svelte-k9legf"}"></figure></div></div>
  <figure class="${"waves svelte-k9legf"}"><img class="${"wave1 svelte-k9legf"}" alt="${""}" src="${"wave1.svg"}">
    <img class="${"wave2 svelte-k9legf"}" alt="${""}" src="${"wave2.svg"}"></figure></header>

<main class="${"px-10 py-16 svelte-k9legf"}">${validate_component(GradientHeading, "GradientHeading").$$render($$result, { depth: 2 }, {}, {
		default: () => `My
    <br class="${"svelte-k9legf"}">
    work
  `
