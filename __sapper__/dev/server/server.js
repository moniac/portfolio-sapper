...
<div class="${"container mx-auto max-w-2xl py-8 lg:py-8 px-8"}">${validate_component(GradientHeading, "GradientHeading").$$render($$result, {}, {}, {
		default: () => `Recent
    <br>
    posts
  `
...
<div class="${"container mx-auto max-w-2xl py-8 lg:py-8 px-8"}">${validate_component(GradientHeading, "GradientHeading").$$render($$result, {}, {}, { default: () => `${escape(post.title)}` })}
