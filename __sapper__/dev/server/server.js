...
const css$1 = {
	code: "h1.svelte-omuo3{font-size:4.8em;text-transform:uppercase;font-weight:700;margin:0 0 0.5em 0;white-space:normal}h1.svelte-omuo3{background-image:linear-gradient(180deg, #5b5cf1, #21b3ff);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;line-height:0.9;margin-left:-6px;transition:background-image 225ms ease}.dark-mode h1{background-image:linear-gradient(to bottom, #f15b74, #ff6021)}.role.svelte-omuo3{font-size:40px;margin-bottom:16px}.avatar.svelte-omuo3{animation:svelte-omuo3-hover 4s ease infinite alternate-reverse}.avatar.svelte-omuo3 img.svelte-omuo3,.avatar.svelte-omuo3 source.svelte-omuo3{max-width:200px}.shadow.svelte-omuo3{animation:svelte-omuo3-hoverShadow 4s ease infinite alternate-reverse;box-shadow:none;max-width:200px}@media(min-width: 768px){h1.svelte-omuo3{font-size:9.375em}.avatar.svelte-omuo3 img.svelte-omuo3,.avatar.svelte-omuo3 source.svelte-omuo3{max-width:400px}}@keyframes svelte-omuo3-hover{0%{transform:translateY(0%)}100%{transform:translateY(2%)}}@keyframes svelte-omuo3-hoverShadow{0%{transform:scale(1)}100%{transform:scale(1.2)}}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<script>\\n  import Row from \\\"../components/Row.svelte\\\";\\n</script>\\n\\n<style>\\n  h1 {\\n    font-size: 4.8em;\\n    text-transform: uppercase;\\n    font-weight: 700;\\n    margin: 0 0 0.5em 0;\\n    white-space: normal;\\n  }\\n\\n  h1 {\\n    background-image: linear-gradient(180deg, #5b5cf1, #21b3ff);\\n    -webkit-background-clip: text;\\n    background-clip: text;\\n    -webkit-text-fill-color: transparent;\\n    line-height: 0.9;\\n    margin-left: -6px;\\n    transition: background-image 225ms ease;\\n  }\\n\\n  :global(.dark-mode h1) {\\n    background-image: linear-gradient(to bottom, #f15b74, #ff6021);\\n  }\\n\\n  .role {\\n    font-size: 40px;\\n    margin-bottom: 16px;\\n  }\\n\\n  .avatar {\\n    animation: hover 4s ease infinite alternate-reverse;\\n  }\\n\\n  .avatar img,\\n  .avatar source {\\n    max-width: 200px;\\n  }\\n\\n  .shadow {\\n    animation: hoverShadow 4s ease infinite alternate-reverse;\\n    box-shadow: none;\\n    max-width: 200px;\\n  }\\n\\n  @media (min-width: 768px) {\\n    h1 {\\n      font-size: 9.375em;\\n    }\\n\\n    .avatar img,\\n    .avatar source {\\n      max-width: 400px;\\n    }\\n  }\\n\\n  @keyframes hover {\\n    0% {\\n      transform: translateY(0%);\\n    }\\n\\n    100% {\\n      transform: translateY(2%);\\n    }\\n  }\\n\\n  @keyframes hoverShadow {\\n    0% {\\n      transform: scale(1);\\n    }\\n\\n    100% {\\n      transform: scale(1.2);\\n    }\\n  }\\n</style>\\n\\n<svelte:head>\\n  <title>Home | Portfolio of Mohammed Mulazada</title>\\n</svelte:head>\\n<div\\n  class=\\\"flex flex-col-reverse items-center px-6 justify-center lg:flex-row\\n  flex-row justify-between flex-wrap\\\">\\n  <div>\\n    <p class=\\\"role\\\">Front-End</p>\\n    <h1>\\n      Dev-\\n      <br />\\n      eloper\\n    </h1>\\n\\n    <p>\\n      Welcome to my portfolio. My name is Mohammed, but please call me Mo.\\n      <br />\\n      This site is still a work in progress...\\n    </p>\\n  </div>\\n\\n  <Row flexDirection=\\\"column\\\">\\n    <picture class=\\\"avatar\\\">\\n      <source srcset=\\\"g/mo-366.webp\\\" type=\\\"image/webp\\\" />\\n      <img alt=\\\"Image of Mohammed Mulazada\\\" src=\\\"mo.png\\\" />\\n    </picture>\\n    <img class=\\\"shadow\\\" alt=\\\"\\\" src={'shadow.png'} />\\n  </Row>\\n</div>\\n\\n<main>\\n  <section>\\n    <ul>\\n      <!-- <li>test</li> -->\\n    </ul>\\n  </section>\\n</main>\\n\"],\"names\":[],\"mappings\":\"AAKE,EAAE,aAAC,CAAC,AACF,SAAS,CAAE,KAAK,CAChB,cAAc,CAAE,SAAS,CACzB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,CACnB,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,EAAE,aAAC,CAAC,AACF,gBAAgB,CAAE,gBAAgB,MAAM,CAAC,CAAC,OAAO,CAAC,CAAC,OAAO,CAAC,CAC3D,uBAAuB,CAAE,IAAI,CAC7B,eAAe,CAAE,IAAI,CACrB,uBAAuB,CAAE,WAAW,CACpC,WAAW,CAAE,GAAG,CAChB,WAAW,CAAE,IAAI,CACjB,UAAU,CAAE,gBAAgB,CAAC,KAAK,CAAC,IAAI,AACzC,CAAC,AAEO,aAAa,AAAE,CAAC,AACtB,gBAAgB,CAAE,gBAAgB,EAAE,CAAC,MAAM,CAAC,CAAC,OAAO,CAAC,CAAC,OAAO,CAAC,AAChE,CAAC,AAED,KAAK,aAAC,CAAC,AACL,SAAS,CAAE,IAAI,CACf,aAAa,CAAE,IAAI,AACrB,CAAC,AAED,OAAO,aAAC,CAAC,AACP,SAAS,CAAE,kBAAK,CAAC,EAAE,CAAC,IAAI,CAAC,QAAQ,CAAC,iBAAiB,AACrD,CAAC,AAED,oBAAO,CAAC,gBAAG,CACX,oBAAO,CAAC,MAAM,aAAC,CAAC,AACd,SAAS,CAAE,KAAK,AAClB,CAAC,AAED,OAAO,aAAC,CAAC,AACP,SAAS,CAAE,wBAAW,CAAC,EAAE,CAAC,IAAI,CAAC,QAAQ,CAAC,iBAAiB,CACzD,UAAU,CAAE,IAAI,CAChB,SAAS,CAAE,KAAK,AAClB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,EAAE,aAAC,CAAC,AACF,SAAS,CAAE,OAAO,AACpB,CAAC,AAED,oBAAO,CAAC,gBAAG,CACX,oBAAO,CAAC,MAAM,aAAC,CAAC,AACd,SAAS,CAAE,KAAK,AAClB,CAAC,AACH,CAAC,AAED,WAAW,kBAAM,CAAC,AAChB,EAAE,AAAC,CAAC,AACF,SAAS,CAAE,WAAW,EAAE,CAAC,AAC3B,CAAC,AAED,IAAI,AAAC,CAAC,AACJ,SAAS,CAAE,WAAW,EAAE,CAAC,AAC3B,CAAC,AACH,CAAC,AAED,WAAW,wBAAY,CAAC,AACtB,EAAE,AAAC,CAAC,AACF,SAAS,CAAE,MAAM,CAAC,CAAC,AACrB,CAAC,AAED,IAAI,AAAC,CAAC,AACJ,SAAS,CAAE,MAAM,GAAG,CAAC,AACvB,CAAC,AACH,CAAC\"}"
};
...
<div class="${"flex flex-col-reverse items-center px-6 justify-center lg:flex-row\n  flex-row justify-between flex-wrap"}">
  <div>
    <p class="${"role svelte-omuo3"}">Front-End</p>
    <h1 class="${"svelte-omuo3"}">
      Dev-
      <br>
      eloper
    </h1>
  ...
  ${validate_component(Row, "Row").$$render($$result, { flexDirection: "column" }, {}, {
		default: () => `
    <picture class="${"avatar svelte-omuo3"}">
      <source srcset="${"g/mo-366.webp"}" type="${"image/webp"}" class="${"svelte-omuo3"}">
      <img alt="${"Image of Mohammed Mulazada"}" src="${"mo.png"}" class="${"svelte-omuo3"}">
    </picture>
    <img class="${"shadow svelte-omuo3"}" alt="${""}"${add_attribute("src", "shadow.png", 0)}>
  `
	})}
</div>
