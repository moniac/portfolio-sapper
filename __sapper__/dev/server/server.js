...
<header class="${"h-full svelte-1losals"}"><a href="${"/"}" class="${"logo_container px-10 mt-10 svelte-1losals"}"><img src="${"mo_logo.svg"}" alt="${"logo from moniac"}" class="${"svelte-1losals"}">
    <aside class="${"text-white pl-4 svelte-1losals"}"><h1 class="${"svelte-1losals"}">Mohammed Mulazada</h1>
      <h2 class="${"svelte-1losals"}">Front-end Developer</h2></aside></a>

  <div class="${"header-holder svelte-1losals"}"><div class="${"px-10 intro text-white svelte-1losals"}"><h1 class="${"text-4xl leading-none mb-4 svelte-1losals"}"><span class="${"font-bold text-6xl svelte-1losals"}">Welcome</span>
        <br class="${"svelte-1losals"}">
        to my portfolio
      </h1>
      <p class="${"max-w-lg svelte-1losals"}">I am Mohammed Mulazada, a Front-End Developer based in Amsterdam. With a
        passion for all things web, I am looking for challenges and new things
        to learn each and every day.
      </p></div>

    <div class="${"figure-holder svelte-1losals"}"><figure class="${"square svelte-1losals"}"></figure>
      <figure class="${"triangle svelte-1losals"}"><img alt="${""}" src="${"./triangle.svg"}" class="${"svelte-1losals"}"></figure>
      <figure class="${"polygon svelte-1losals"}"><img alt="${""}" src="${"./polygon.svg"}" class="${"svelte-1losals"}"></figure></div></div>
  <figure class="${"waves svelte-1losals"}"><img class="${"wave1 svelte-1losals"}" alt="${""}" src="${"wave1.svg"}">
    <img class="${"wave2 svelte-1losals"}" alt="${""}" src="${"wave2.svg"}"></figure></header>

<main class="${"px-10 py-16 svelte-1losals"}">${validate_component(GradientHeading, "GradientHeading").$$render($$result, { depth: 2 }, {}, {
		default: () => `My
    <br class="${"svelte-1losals"}">
    work
  `
