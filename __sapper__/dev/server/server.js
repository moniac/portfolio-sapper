...
<header class="${"h-full svelte-1liv705"}"><a href="${"/"}" class="${"logo_container px-10 mt-10 svelte-1liv705"}"><img src="${"mo_logo.svg"}" alt="${"logo from moniac"}">
    <aside class="${"text-white pl-4"}"><h1>Mohammed Mulazada</h1>
      <h2>Front-end Developer</h2></aside></a>

  <div class="${"header-holder svelte-1liv705"}"><div class="${"px-10 intro text-white svelte-1liv705"}"><h1 class="${"text-4xl leading-none mb-4"}"><span class="${"font-bold text-6xl"}">Welcome</span>
        <br>
        to my portfolio
      </h1>
    ...
    <div class="${"figure-holder svelte-1liv705"}"><figure class="${"square svelte-1liv705"}"></figure>
      <figure class="${"triangle svelte-1liv705"}"><img alt="${""}" src="${"./triangle.svg"}"></figure>
      <figure class="${"polygon svelte-1liv705"}"><img alt="${""}" src="${"./polygon.svg"}"></figure></div></div>
  <figure class="${"waves svelte-1liv705"}"><img class="${"wave1 svelte-1liv705"}" alt="${""}" src="${"wave1.svg"}">
    <img class="${"wave2 svelte-1liv705"}" alt="${""}" src="${"wave2.svg"}"></figure></header>

<main class="${"px-10 py-16 svelte-1liv705"}">${validate_component(GradientHeading, "GradientHeading").$$render($$result, { depth: 2 }, {}, {
		default: () => `My
    <br>
    work
  `
