...
var myFirstBlog = "<hr>\n<p>title: My first blog\nslug: My first blog\ndate: &quot;2019-06-11T08:38:00.000Z&quot;\nsummary: An introduction to me.</p>\n<hr>\n<h1 id=\"hello-world\">Hello World!</h1>\n<p>Wow this actually works.</p>\n<p><img src=\"https://media.giphy.com/media/JIX9t2j0ZTN9S/giphy.gif\" alt=\"test\"></p>\n<pre><code class=\"language-js\">const awesome = true;</code></pre>\n<table>\n<thead>\n<tr>\n<th>test</th>\n<th>esa</th>\n</tr>\n</thead>\n<tbody><tr>\n<td>d</td>\n<td>a</td>\n</tr>\n</tbody></table>\n";
...
const GradientHeading = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${depth === 1
	? `<h1 class="${"GradientHeading h" + escape(depth) + " " + escape(className) + " -ml-1 mb-4 lg:mb-16 lg:-ml-2" + " svelte-139uw5k"}">
    ${$$slots.default ? $$slots.default({}) : ``}
  </h1>`
	: `${depth === 2
		? `<h2 class="${"GradientHeading h" + escape(depth) + " " + escape(className) + " svelte-139uw5k"}">
      ${$$slots.default ? $$slots.default({}) : ``}
    </h2>`
		: `<h3 class="${"GradientHeading h" + escape(depth) + " " + escape(className) + " svelte-139uw5k"}">
      ${$$slots.default ? $$slots.default({}) : ``}
    </h3>`}`}`;
});
...
<header class="${"h-full svelte-ikg5g7"}">
  <a href="${"/"}" class="${"logo_container px-10 mt-10 svelte-ikg5g7"}">
    <img src="${"mo_logo.svg"}" alt="${"logo from moniac"}">
    <aside class="${"text-white"}">
      <h1>Mohammed Mulazada</h1>
      <h2>Front-end Developer</h2>
  ...
  <div class="${"px-10 intro text-white svelte-ikg5g7"}">
    <h1 class="${"text-4xl leading-none mb-4"}">
      <span class="${"font-bold text-6xl"}">Welcome</span>
      <br>
      to my portfolio
  ...
  <figure class="${"waves svelte-ikg5g7"}">
    <img class="${"wave1 svelte-ikg5g7"}" alt="${""}" src="${"wave1.png"}">
    <img class="${"wave2 svelte-ikg5g7"}" alt="${""}" src="${"wave2.svg"}">
  </figure>

  <div class="${"figure-holder svelte-ikg5g7"}">
    <figure class="${"square svelte-ikg5g7"}"></figure>
  </div>
</header>

<main class="${"px-10 py-16"}">
  ${validate_component(GradientHeading, "GradientHeading").$$render($$result, { depth: 2 }, {}, {
		default: () => `
    My
    <br>
    work
...
<div class="${"container py-24 lg:py-32 px-4 mx-auto max-w-6xl"}">
  ${validate_component(GradientHeading, "GradientHeading").$$render($$result, {}, {}, {
		default: () => `
    Recent
    <br>
    posts
  ...
  <ul class="${"svelte-1uzksw3"}">
    ${each(posts, post => `
      <li>
        <a class="${"underline"}" rel="${"prefetch"}" href="${"blog/" + escape(post.slug) + "/"}">
          ${escape(post.title)}
        </a>
        <summary class="${"italic"}">
          ${escape(post.summary)}
          <br>
          ${escape(post.readingTime)}
        </summary>
      </li>`)}
  </ul>
</div>`;
...
const U5Bslugu5D = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${($$result.head += `<title>${escape(post.title)}</title><style>
    code[class*="language-"],
    pre[class*="language-"] {
      color: #f8f8f2;
      background: none;
...
<div class="${"container py-24 lg:py-24 px-4 mx-auto max-w-6xl"}">
  ${validate_component(GradientHeading, "GradientHeading").$$render($$result, {}, {}, { default: () => `${escape(post.title)}` })}

  <div class="${"content svelte-fvwkvm"}">
    ${post.html}
  </div>
</div>`;
});
...
const css$4 = {
	code: "nav.svelte-zjmb21{border-bottom:1px solid rgba(160, 177, 255, 0.486);font-weight:300;padding:0 1em;max-height:57px}ul.svelte-zjmb21::after{content:\"\";display:block;clear:both}li.svelte-zjmb21{display:block;float:left;height:57px}.selected.svelte-zjmb21{position:relative;display:inline-block}.selected.svelte-zjmb21::after{position:absolute;content:\"\";width:calc(100% - 1em);height:2px;background-color:rgb(24, 119, 243);display:block;bottom:-1px}a.svelte-zjmb21{text-decoration:none;padding:1em 0.5em;display:block}",
...
const manifest = {
	server_routes: [
		...
		{
			// blog/posts/my-first-blog.md
			pattern: /^\/blog\/posts\/my-first-blog\/?$/,
			handlers: route_1,
			params: () => ({})
		},
...
function serve({ prefix, pathname, cache_control }
	...
	const read =  (file) => fs$1.readFileSync(path$1.resolve(build_dir, file))
		;
