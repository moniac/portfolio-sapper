...
const GradientHeading = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${depth === 1
	? `<h1 class="${"GradientHeading h" + escape(depth) + " " + escape(className) + " -ml-1 mb-4 lg:mb-16 lg:-ml-2" + " svelte-luhsqx"}">${$$slots.default ? $$slots.default({}) : ``}</h1>`
	: `${depth === 2
...
<header class="${escape(null_to_empty(headerStyles[Math.floor(headerStyles.length * Math.random())])) + " svelte-kvonrc"}"><a href="${"/"}" class="${"logo_container px-10 mt-10 svelte-kvonrc"}"><img src="${"mo_logo.svg"}" alt="${"logo from moniac"}">
    <aside class="${"text-white pl-4"}"><h1>Mohammed Mulazada</h1>
      <h2>Front-end Developer</h2></aside></a>
  <div class="${"px-10 intro text-white svelte-kvonrc"}"><h1 class="${"text-4xl leading-none mb-4"}"><span class="${"font-bold text-6xl"}">Welcome</span>
      <br>
      to my portfolio
    </h1>
  ...
  <figure class="${"waves svelte-kvonrc"}"><img class="${"wave1 svelte-kvonrc"}" alt="${""}" src="${"wave1.png"}">
    <img class="${"wave2 svelte-kvonrc"}" alt="${""}" src="${"wave2.svg"}"></figure>

  <div class="${"figure-holder svelte-kvonrc"}"><figure class="${"square svelte-kvonrc"}"></figure>
    <figure class="${"triangle svelte-kvonrc"}"><img alt="${""}" src="${"./triangle.svg"}"></figure>
    <figure class="${"polygon svelte-kvonrc"}"><img alt="${""}" src="${"./polygon.svg"}"></figure></div></header>
...
<div class="${"container py-24 lg:py-32 px-4 mx-auto max-w-6xl"}">${validate_component(GradientHeading, "GradientHeading").$$render($$result, {}, {}, {
		default: () => `Recent
    <br>
    posts
  `
  ...
  <ul class="${"svelte-1emtgb4"}">${each(posts, post => `
...
<div class="${"container py-24 lg:py-24 px-4 mx-auto max-w-6xl"}">${validate_component(GradientHeading, "GradientHeading").$$render($$result, {}, {}, { default: () => `${escape(post.title)}` })}
