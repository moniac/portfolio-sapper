...
const css$1 = {
	code: "header.svelte-16x3p9g.svelte-16x3p9g{background-image:linear-gradient(225deg, #010220 0%, #000000 100%);height:80vh;overflow:hidden;position:relative;display:flex;flex-direction:column;justify-content:space-between}.wave1.svelte-16x3p9g.svelte-16x3p9g{position:absolute;bottom:-25%;width:100%;animation:svelte-16x3p9g-wave 4s ease infinite alternate;z-index:1}.wave2.svelte-16x3p9g.svelte-16x3p9g{position:absolute;bottom:-20%;width:100%;animation:svelte-16x3p9g-wave 2s ease infinite alternate, svelte-16x3p9g-hue 5s ease infinite;animation-delay:0.2s;z-index:1}.wave1.svelte-16x3p9g.svelte-16x3p9g,.wave2.svelte-16x3p9g.svelte-16x3p9g{min-width:1200px}.intro.svelte-16x3p9g.svelte-16x3p9g{z-index:99}.figure-holder.svelte-16x3p9g.svelte-16x3p9g{display:flex;margin-top:4rem;z-index:10}.figure-holder.svelte-16x3p9g>.svelte-16x3p9g{margin-left:2rem}.square.svelte-16x3p9g.svelte-16x3p9g{height:82px;width:82px;opacity:0.4;transform:rotate(45deg);border:10px solid #ffffff;filter:blur(12px);animation:svelte-16x3p9g-rotate 8s linear infinite;margin-left:80px;z-index:1}.triangle.svelte-16x3p9g.svelte-16x3p9g{opacity:0.9;animation:svelte-16x3p9g-hover 4s ease alternate infinite;margin-top:4rem}.polygon.svelte-16x3p9g.svelte-16x3p9g{opacity:0.9;animation:svelte-16x3p9g-rotate 5s linear infinite reverse;filter:blur(8px);width:6rem;transform-origin:50% 80%;height:4rem}.waves.svelte-16x3p9g.svelte-16x3p9g{opacity:0.6;z-index:0}.header-holder.svelte-16x3p9g.svelte-16x3p9g{display:flex;flex-direction:column-reverse}.logo_container.svelte-16x3p9g.svelte-16x3p9g{max-height:52px;display:flex}.logo_container > img{max-height:52px}@media(min-width: 768px){header.svelte-16x3p9g.svelte-16x3p9g{clip-path:polygon(0 0, 100% 0, 100% 80%, 0% 100%);min-height:800px}.header-holder.svelte-16x3p9g.svelte-16x3p9g{flex-direction:row}.figure-holder.svelte-16x3p9g.svelte-16x3p9g{margin-top:-15rem;margin-right:10rem;margin-left:auto}.wave1.svelte-16x3p9g.svelte-16x3p9g{bottom:-20%}.wave2.svelte-16x3p9g.svelte-16x3p9g{bottom:-15%}}@media(min-width: 1000px){.wave1.svelte-16x3p9g.svelte-16x3p9g{bottom:-28%}.wave2.svelte-16x3p9g.svelte-16x3p9g{bottom:-20%}}@media(min-width: 2000px){.wave1.svelte-16x3p9g.svelte-16x3p9g{bottom:-45%}.wave2.svelte-16x3p9g.svelte-16x3p9g{bottom:-35%}}@keyframes svelte-16x3p9g-hover{from{transform:translateY(0)}to{transform:translateY(-20%)}}@keyframes svelte-16x3p9g-rotateStep{0%{transform:rotate(0)}20%{transform:rotate(72deg)}40%{transform:rotate(144deg)}60%{transform:rotate(216deg)}80%{transform:rotate(288deg)}100%{transform:rotate(360deg)}}@keyframes svelte-16x3p9g-rotate{from{transform:rotate(0)}to{transform:rotate(1turn)}}@keyframes svelte-16x3p9g-hue{from{-webkit-filter:hue-rotate(0deg)}to{-webkit-filter:hue-rotate(-360deg)}}@keyframes svelte-16x3p9g-wave{0%{transform:translateY(0%)}100%{transform:translateY(-5%)}}@media(prefers-reduced-motion: reduce){.wave1.svelte-16x3p9g.svelte-16x3p9g,.wave2.svelte-16x3p9g.svelte-16x3p9g,.square.svelte-16x3p9g.svelte-16x3p9g{animation:none}}",
...
<header class="${"h-full svelte-16x3p9g"}"><a href="${"/"}" class="${"logo_container px-10 mt-10 svelte-16x3p9g"}"><img src="${"mo_logo.svg"}" alt="${"logo from moniac"}">
    <aside class="${"text-white pl-4"}"><h1>Mohammed Mulazada</h1>
      <h2>Front-end Developer</h2></aside></a>

  <div class="${"header-holder svelte-16x3p9g"}"><div class="${"px-10 intro text-white svelte-16x3p9g"}"><h1 class="${"text-4xl leading-none mb-4"}"><span class="${"font-bold text-6xl"}">Welcome</span>
        <br>
        to my portfolio
      </h1>
    ...
    <div class="${"figure-holder svelte-16x3p9g"}"><figure class="${"square svelte-16x3p9g"}"></figure>
      <figure class="${"triangle svelte-16x3p9g"}"><img alt="${""}" src="${"./triangle.svg"}"></figure>
      <figure class="${"polygon svelte-16x3p9g"}"><img alt="${""}" src="${"./polygon.svg"}"></figure></div></div>
  <figure class="${"waves svelte-16x3p9g"}"><img class="${"wave1 svelte-16x3p9g"}" alt="${""}" src="${"wave1.svg"}">
    <img class="${"wave2 svelte-16x3p9g"}" alt="${""}" src="${"wave2.svg"}"></figure></header>

<main class="${"px-10 py-16 svelte-16x3p9g"}">${validate_component(GradientHeading, "GradientHeading").$$render($$result, { depth: 2 }, {}, {
		default: () => `My
    <br>
    work
  `
