...
<header class="${"h-full svelte-o7z646"}"><a href="${"/"}" class="${"logo_container px-10 mt-10 svelte-o7z646"}"><img src="${"mo_logo.svg"}" alt="${"logo from moniac"}">
    <aside class="${"text-white pl-4"}"><h1>Mohammed Mulazada</h1>
      <h2>Front-end Developer</h2></aside></a>

  <div class="${"header-holder svelte-o7z646"}"><div class="${"px-10 intro text-white svelte-o7z646"}"><h1 class="${"text-4xl leading-none mb-4"}"><span class="${"font-bold text-6xl"}">Welcome</span>
        <br>
        to my portfolio
      </h1>
    ...
    <div class="${"figure-holder svelte-o7z646"}"><figure class="${"square svelte-o7z646"}"></figure>
      <figure class="${"triangle svelte-o7z646"}"><img alt="${""}" src="${"./triangle.svg"}"></figure>
      <figure class="${"polygon svelte-o7z646"}"><img alt="${""}" src="${"./polygon.svg"}"></figure></div></div>
  <figure class="${"waves svelte-o7z646"}"><img class="${"wave1 svelte-o7z646"}" alt="${""}" src="${"wave1.svg"}">
    <img class="${"wave2 svelte-o7z646"}" alt="${""}" src="${"wave2.svg"}"></figure></header>

<main class="${"px-10 py-16 svelte-o7z646"}">${validate_component(GradientHeading, "GradientHeading").$$render($$result, { depth: 2 }, {}, {
		default: () => `My
    <br>
    work
  `
