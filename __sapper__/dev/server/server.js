...
<header class="${"h-full svelte-abgpkb"}"><a href="${"/"}" class="${"logo_container px-10 mt-10 svelte-abgpkb"}"><img src="${"mo_logo.svg"}" alt="${"logo from moniac"}">
    <aside class="${"text-white pl-4"}"><h1>Mohammed Mulazada</h1>
      <h2>Front-end Developer</h2></aside></a>
  <div class="${"px-10 intro text-white svelte-abgpkb"}"><h1 class="${"text-4xl leading-none mb-4"}"><span class="${"font-bold text-6xl"}">Welcome</span>
      <br>
      to my portfolio
    </h1>
  ...
  <figure class="${"waves svelte-abgpkb"}"><img class="${"wave1 svelte-abgpkb"}" alt="${""}" src="${"wave1.svg"}">
    <img class="${"wave2 svelte-abgpkb"}" alt="${""}" src="${"wave2.svg"}"></figure>

  <div class="${"figure-holder svelte-abgpkb"}"><figure class="${"square svelte-abgpkb"}"></figure>
    <figure class="${"triangle svelte-abgpkb"}"><img alt="${""}" src="${"./triangle.svg"}"></figure>
    <figure class="${"polygon svelte-abgpkb"}"><img alt="${""}" src="${"./polygon.svg"}"></figure></div></header>
