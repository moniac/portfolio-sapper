...
<header class="${"h-full svelte-7rby0j"}"><a href="${"/"}" class="${"logo_container px-10 mt-10 svelte-7rby0j"}"><img src="${"mo_logo.svg"}" alt="${"logo from moniac"}">
    <aside class="${"text-white pl-4"}"><h1>Mohammed Mulazada</h1>
      <h2>Front-end Developer</h2></aside></a>
  <div class="${"px-10 intro text-white svelte-7rby0j"}"><h1 class="${"text-4xl leading-none mb-4"}"><span class="${"font-bold text-6xl"}">Welcome</span>
      <br>
      to my portfolio
    </h1>
  ...
  <figure class="${"waves svelte-7rby0j"}"><img class="${"wave1 svelte-7rby0j"}" alt="${""}" src="${"wave1.svg"}">
    <img class="${"wave2 svelte-7rby0j"}" alt="${""}" src="${"wave2.svg"}"></figure>

  <div class="${"figure-holder svelte-7rby0j"}"><figure class="${"square svelte-7rby0j"}"></figure>
    <figure class="${"triangle svelte-7rby0j"}"><img alt="${""}" src="${"./triangle.svg"}"></figure>
    <figure class="${"polygon svelte-7rby0j"}"><img alt="${""}" src="${"./polygon.svg"}"></figure></div></header>
