...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div1, "class", "flex flex-col-reverse items-center px-8 justify-center lg:flex-row\n  flex-row justify-between flex-wrap");
