...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 42, 8, 882);
			attr_dev(summary, "class", "italic");
			add_location(summary, file, 45, 8, 987);
			add_location(li, file, 41, 6, 869);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(ul, file, 35, 2, 612);
			attr_dev(div, "class", "container py-32 mx-auto");
