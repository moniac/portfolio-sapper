...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", h1_class_value = "GradientHeading h" + /*depth*/ ctx[0] + " " + /*className*/ ctx[1] + " -ml-1 mb-8 lg:mb-16 lg:-ml-2" + " svelte-luhsqx");
		...
		p: function update(ctx, dirty) {
			...
			if (!current || dirty & /*depth, className*/ 3 && h1_class_value !== (h1_class_value = "GradientHeading h" + /*depth*/ ctx[0] + " " + /*className*/ ctx[1] + " -ml-1 mb-8 lg:mb-16 lg:-ml-2" + " svelte-luhsqx")) {
