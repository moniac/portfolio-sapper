...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 104, 6, 1802);
			add_location(br, file, 105, 6, 1856);
			attr_dev(h1, "class", "text-4xl");
			add_location(h1, file, 103, 4, 1774);
			attr_dev(div0, "class", "px-10 intro text-white svelte-1eutczp");
			add_location(div0, file, 102, 2, 1733);
			attr_dev(img0, "class", "wave1 svelte-1eutczp");
			attr_dev(img0, "alt", "");
			if (img0.src !== (img0_src_value = "wave1.svg")) attr_dev(img0, "src", img0_src_value);
			add_location(img0, file, 111, 4, 1934);
			attr_dev(img1, "class", "wave2 svelte-1eutczp");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave2.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file, 112, 4, 1983);
			attr_dev(figure0, "class", "waves svelte-1eutczp");
			add_location(figure0, file, 110, 2, 1907);
			attr_dev(figure1, "class", "square svelte-1eutczp");
			add_location(figure1, file, 116, 4, 2075);
			attr_dev(div1, "class", "figure-holder svelte-1eutczp");
			add_location(div1, file, 115, 2, 2043);
			attr_dev(header, "class", "h-full svelte-1eutczp");
			add_location(header, file, 100, 0, 1706);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
