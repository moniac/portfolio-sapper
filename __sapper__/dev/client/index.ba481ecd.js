import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, c as create_slot, v as validate_slots, e as element, a as claim_element, b as children, f as detach_dev, g as attr_dev, h as add_location, j as insert_dev, k as get_slot_context, l as get_slot_changes, t as transition_in, m as transition_out, n as space, o as text, p as create_component, q as query_selector_all, r as claim_space, u as claim_text, w as claim_component, x as append_dev, y as mount_component, z as destroy_component } from './client.d5a35e5d.js';
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(br, "class", "svelte-1gp1sf9");
			add_location(br, file$1, 259, 4, 4829);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img0, "class", "svelte-1gp1sf9");
			add_location(img0, file$1, 219, 4, 3664);
			attr_dev(h10, "class", "svelte-1gp1sf9");
			add_location(h10, file$1, 221, 6, 3757);
			attr_dev(h2, "class", "svelte-1gp1sf9");
			add_location(h2, file$1, 222, 6, 3791);
			attr_dev(aside, "class", "text-white pl-4 svelte-1gp1sf9");
			add_location(aside, file$1, 220, 4, 3718);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "logo_container px-10 mt-10 svelte-1gp1sf9");
			add_location(a, file$1, 218, 2, 3611);
			attr_dev(span, "class", "font-bold text-6xl svelte-1gp1sf9");
			add_location(span, file$1, 229, 8, 3973);
			attr_dev(br, "class", "svelte-1gp1sf9");
			add_location(br, file$1, 230, 8, 4030);
			attr_dev(h11, "class", "text-4xl leading-none mb-4 svelte-1gp1sf9");
			add_location(h11, file$1, 228, 6, 3924);
			attr_dev(p, "class", "max-w-lg svelte-1gp1sf9");
			add_location(p, file$1, 233, 6, 4082);
			attr_dev(div0, "class", "px-10 intro text-white svelte-1gp1sf9");
			add_location(div0, file$1, 227, 4, 3880);
			attr_dev(figure0, "class", "square svelte-1gp1sf9");
			add_location(figure0, file$1, 241, 6, 4369);
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "./triangle.svg")) attr_dev(img1, "src", img1_src_value);
			attr_dev(img1, "class", "svelte-1gp1sf9");
			add_location(img1, file$1, 243, 8, 4437);
			attr_dev(figure1, "class", "triangle svelte-1gp1sf9");
			add_location(figure1, file$1, 242, 6, 4402);
			attr_dev(img2, "alt", "");
			if (img2.src !== (img2_src_value = "./polygon.svg")) attr_dev(img2, "src", img2_src_value);
			attr_dev(img2, "class", "svelte-1gp1sf9");
			add_location(img2, file$1, 246, 8, 4531);
			attr_dev(figure2, "class", "polygon svelte-1gp1sf9");
			add_location(figure2, file$1, 245, 6, 4497);
			attr_dev(div1, "class", "figure-holder svelte-1gp1sf9");
			add_location(div1, file$1, 240, 4, 4334);
			attr_dev(div2, "class", "header-holder svelte-1gp1sf9");
			add_location(div2, file$1, 226, 2, 3847);
			attr_dev(img3, "class", "wave1 svelte-1gp1sf9");
			attr_dev(img3, "alt", "");
			if (img3.src !== (img3_src_value = "wave1.svg")) attr_dev(img3, "src", img3_src_value);
			add_location(img3, file$1, 251, 4, 4636);
			attr_dev(img4, "class", "wave2 svelte-1gp1sf9");
			attr_dev(img4, "alt", "");
			if (img4.src !== (img4_src_value = "wave2.svg")) attr_dev(img4, "src", img4_src_value);
			add_location(img4, file$1, 252, 4, 4686);
			attr_dev(figure3, "class", "waves svelte-1gp1sf9");
			add_location(figure3, file$1, 250, 2, 4608);
			attr_dev(header, "class", "h-full svelte-1gp1sf9");
			add_location(header, file$1, 217, 0, 3584);
			attr_dev(main, "class", "px-10 py-16 svelte-1gp1sf9");
			add_location(main, file$1, 256, 0, 4758);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
