...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div1, "class", "flex flex-col sm:flex-row sm:align-centre sm:justify-centre flex-row\n  justify-between flex-wrap");
