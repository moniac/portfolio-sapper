...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 102, 6, 1769);
			add_location(br, file, 103, 6, 1823);
			attr_dev(h1, "class", "text-4xl");
			add_location(h1, file, 101, 4, 1741);
			attr_dev(div0, "class", "text-white");
			add_location(div0, file, 100, 2, 1712);
			attr_dev(img0, "class", "wave1 svelte-u0q0p0");
			attr_dev(img0, "alt", "");
			if (img0.src !== (img0_src_value = "wave1.svg")) attr_dev(img0, "src", img0_src_value);
			add_location(img0, file, 109, 4, 1901);
			attr_dev(img1, "class", "wave2 svelte-u0q0p0");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave2.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file, 110, 4, 1950);
			attr_dev(figure0, "class", "waves svelte-u0q0p0");
			add_location(figure0, file, 108, 2, 1874);
			attr_dev(figure1, "class", "square svelte-u0q0p0");
			add_location(figure1, file, 114, 4, 2042);
			attr_dev(div1, "class", "figure-holder svelte-u0q0p0");
			add_location(div1, file, 113, 2, 2010);
			attr_dev(header, "class", "h-full svelte-u0q0p0");
			add_location(header, file, 98, 0, 1685);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
