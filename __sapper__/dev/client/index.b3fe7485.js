...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 51, 8, 1250);
			add_location(br, file, 56, 10, 1421);
			attr_dev(summary, "class", "italic");
			add_location(summary, file, 54, 8, 1359);
			add_location(li, file, 50, 6, 1236);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input, file, 38, 2, 759);
			attr_dev(ul, "class", "svelte-1emtgb4");
			add_location(ul, file, 44, 2, 966);
			attr_dev(div, "class", "container mx-auto max-w-2xl py-8 lg:lg:py-24 px-8");
