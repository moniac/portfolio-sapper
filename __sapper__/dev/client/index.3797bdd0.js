...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 99, 6, 1731);
			add_location(br, file, 100, 6, 1785);
			attr_dev(h1, "class", "text-4xl");
			add_location(h1, file, 98, 4, 1703);
			attr_dev(div0, "class", "text-white");
			add_location(div0, file, 97, 2, 1674);
			attr_dev(img0, "class", "wave1 svelte-13k5zzr");
			attr_dev(img0, "alt", "");
			if (img0.src !== (img0_src_value = "wave1.svg")) attr_dev(img0, "src", img0_src_value);
			add_location(img0, file, 106, 4, 1863);
			attr_dev(img1, "class", "wave2 svelte-13k5zzr");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave2.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file, 107, 4, 1912);
			attr_dev(figure0, "class", "waves svelte-13k5zzr");
			add_location(figure0, file, 105, 2, 1836);
			attr_dev(figure1, "class", "square svelte-13k5zzr");
			add_location(figure1, file, 111, 4, 2004);
			attr_dev(div1, "class", "figure-holder svelte-13k5zzr");
			add_location(div1, file, 110, 2, 1972);
			attr_dev(header, "class", "h-full svelte-13k5zzr");
			add_location(header, file, 95, 0, 1647);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
