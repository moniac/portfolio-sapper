import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, c as create_slot, v as validate_slots, e as element, a as claim_element, b as children, f as detach_dev, g as attr_dev, h as add_location, j as insert_dev, k as get_slot_context, l as get_slot_changes, t as transition_in, m as transition_out, n as space, o as text, p as create_component, q as query_selector_all, r as claim_space, u as claim_text, w as claim_component, x as append_dev, y as mount_component, z as destroy_component } from './client.788605b8.js';
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br, file$1, 214, 4, 4098);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img0, file$1, 176, 4, 3016);
			add_location(h10, file$1, 178, 6, 3109);
			add_location(h2, file$1, 179, 6, 3143);
			attr_dev(aside, "class", "text-white pl-4");
			add_location(aside, file$1, 177, 4, 3070);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "logo_container px-10 mt-10 svelte-151t2f9");
			add_location(a, file$1, 175, 2, 2963);
			attr_dev(span, "class", "font-bold text-6xl");
			add_location(span, file$1, 184, 6, 3286);
			add_location(br, file$1, 185, 6, 3341);
			attr_dev(h11, "class", "text-4xl leading-none mb-4");
			add_location(h11, file$1, 183, 4, 3239);
			attr_dev(p, "class", "max-w-lg");
			add_location(p, file$1, 188, 4, 3387);
			attr_dev(div0, "class", "px-10 intro text-white svelte-151t2f9");
			add_location(div0, file$1, 182, 2, 3197);
			attr_dev(img1, "class", "wave1 svelte-151t2f9");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave1.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file$1, 196, 4, 3655);
			attr_dev(img2, "class", "wave2 svelte-151t2f9");
			attr_dev(img2, "alt", "");
			if (img2.src !== (img2_src_value = "wave2.svg")) attr_dev(img2, "src", img2_src_value);
			add_location(img2, file$1, 197, 4, 3705);
			attr_dev(figure0, "class", "waves svelte-151t2f9");
			add_location(figure0, file$1, 195, 2, 3627);
			attr_dev(figure1, "class", "square svelte-151t2f9");
			add_location(figure1, file$1, 201, 4, 3801);
			attr_dev(img3, "alt", "");
			if (img3.src !== (img3_src_value = "./triangle.svg")) attr_dev(img3, "src", img3_src_value);
			add_location(img3, file$1, 203, 6, 3865);
			attr_dev(figure2, "class", "triangle svelte-151t2f9");
			add_location(figure2, file$1, 202, 4, 3832);
			attr_dev(img4, "alt", "");
			if (img4.src !== (img4_src_value = "./polygon.svg")) attr_dev(img4, "src", img4_src_value);
			add_location(img4, file$1, 206, 6, 3953);
			attr_dev(figure3, "class", "polygon svelte-151t2f9");
			add_location(figure3, file$1, 205, 4, 3921);
			attr_dev(div1, "class", "figure-holder svelte-151t2f9");
			add_location(div1, file$1, 200, 2, 3768);
			attr_dev(header, "class", "h-full svelte-151t2f9");
			add_location(header, file$1, 174, 0, 2936);
			attr_dev(main, "class", "px-10 py-16");
			add_location(main, file$1, 211, 0, 4027);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
