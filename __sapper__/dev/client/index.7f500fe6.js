...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "logo_container px-10 mt-10 svelte-1agfwie");
			...
			attr_dev(figure2, "class", "triangle svelte-1agfwie");
			add_location(figure2, file, 146, 4, 2796);
			attr_dev(div1, "class", "figure-holder svelte-1agfwie");
			add_location(div1, file, 144, 2, 2734);
			attr_dev(header, "class", "h-full svelte-1agfwie");
