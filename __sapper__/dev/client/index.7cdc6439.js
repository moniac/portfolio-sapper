...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br, file, 46, 10, 1044);
			attr_dev(summary, "class", "italic");
			add_location(summary, file, 44, 8, 984);
