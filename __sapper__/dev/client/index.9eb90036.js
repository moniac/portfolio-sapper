...
function create_default_slot_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(source, file$1, 55, 6, 961);
			...
			add_location(img0, file$1, 56, 6, 1019);
			add_location(picture, file$1, 54, 4, 945);
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "shadow.png")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file$1, 61, 4, 1144);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(ul, file$1, 67, 4, 1218);
			add_location(section, file$1, 66, 2, 1204);
			add_location(main, file$1, 65, 0, 1195);
		},
		m: function mount(target, anchor) {
