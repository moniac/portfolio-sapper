...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "logo_container px-10 mt-10 svelte-ctbyht");
			...
			attr_dev(figure2, "class", "triangle svelte-ctbyht");
			add_location(figure2, file, 157, 4, 2988);
			attr_dev(div1, "class", "figure-holder svelte-ctbyht");
			add_location(div1, file, 155, 2, 2926);
			attr_dev(header, "class", "h-full svelte-ctbyht");
