...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(style, file, 50, 2, 1208);
			attr_dev(div0, "class", "content svelte-wex1v3");
			add_location(div0, file, 174, 2, 3467);
			attr_dev(div1, "class", "container py-24 lg:py-24 px-4 mx-auto max-w-6xl");
			add_location(div1, file, 171, 0, 3352);
		},
		m: function mount(target, anchor) {
