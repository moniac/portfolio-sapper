...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(source, file$1, 90, 6, 1648);
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p0, file$1, 74, 4, 1333);
			add_location(br0, file$1, 77, 6, 1389);
			attr_dev(h1, "class", "svelte-169thcy");
			add_location(h1, file$1, 75, 4, 1367);
			add_location(br1, file$1, 83, 6, 1509);
			add_location(p1, file$1, 81, 4, 1424);
			add_location(div0, file$1, 73, 2, 1323);
			attr_dev(div1, "class", "flex flex-col items-center justify-center px-4 lg:flex-row flex-row\n  justify-between flex-wrap");
			add_location(div1, file$1, 70, 0, 1209);
			add_location(ul, file$1, 102, 4, 1920);
			add_location(section, file$1, 101, 2, 1906);
			add_location(main, file$1, 100, 0, 1897);
		},
		m: function mount(target, anchor) {
