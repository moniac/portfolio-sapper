...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div1, "class", "flex sm:flex-col sm:align-centre sm:justify-centre justify-between\n  flex-wrap");
