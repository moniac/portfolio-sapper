import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, c as create_slot, v as validate_slots, e as element, a as claim_element, b as children, f as detach_dev, g as attr_dev, h as add_location, j as insert_dev, k as get_slot_context, l as get_slot_changes, t as transition_in, m as transition_out, n as space, o as text, p as create_component, q as query_selector_all, r as claim_space, u as claim_text, w as claim_component, x as append_dev, y as mount_component, z as destroy_component } from './client.edeaf6d2.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "logo_container px-10 mt-10 svelte-jn0lng");
			...
			attr_dev(figure2, "class", "triangle svelte-jn0lng");
			...
			attr_dev(figure3, "class", "polygon svelte-jn0lng");
			add_location(figure3, file$1, 198, 4, 3731);
			attr_dev(div1, "class", "figure-holder svelte-jn0lng");
			add_location(div1, file$1, 193, 2, 3578);
			attr_dev(header, "class", "h-full svelte-jn0lng");
