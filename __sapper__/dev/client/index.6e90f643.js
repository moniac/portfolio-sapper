...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(source, file$1, 88, 6, 1576);
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p0, file$1, 72, 4, 1261);
			add_location(br0, file$1, 75, 6, 1317);
			attr_dev(h1, "class", "svelte-169thcy");
			add_location(h1, file$1, 73, 4, 1295);
			add_location(br1, file$1, 81, 6, 1437);
			add_location(p1, file$1, 79, 4, 1352);
			add_location(div0, file$1, 71, 2, 1251);
			attr_dev(div1, "class", "flex justify-between wrap");
			add_location(div1, file$1, 70, 0, 1209);
			add_location(ul, file$1, 100, 4, 1848);
			add_location(section, file$1, 99, 2, 1834);
			add_location(main, file$1, 98, 0, 1825);
		},
		m: function mount(target, anchor) {
