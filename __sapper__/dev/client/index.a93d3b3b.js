...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br, file, 176, 4, 3368);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img0, file, 138, 4, 2322);
			add_location(h10, file, 140, 6, 2413);
			add_location(h2, file, 141, 6, 2446);
			attr_dev(aside, "class", "text-white pl-4");
			add_location(aside, file, 139, 4, 2375);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "logo_container px-10 mt-10 svelte-1jfxtu3");
			add_location(a, file, 137, 2, 2270);
			attr_dev(span, "class", "font-bold text-6xl");
			add_location(span, file, 146, 6, 2584);
			add_location(br, file, 147, 6, 2638);
			attr_dev(h11, "class", "text-4xl leading-none mb-4");
			add_location(h11, file, 145, 4, 2538);
			attr_dev(p, "class", "max-w-lg");
			add_location(p, file, 150, 4, 2681);
			attr_dev(div0, "class", "px-10 intro text-white svelte-1jfxtu3");
			add_location(div0, file, 144, 2, 2497);
			attr_dev(img1, "class", "wave1 svelte-1jfxtu3");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "g/wave1.png")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file, 158, 4, 2941);
			attr_dev(img2, "class", "wave2 svelte-1jfxtu3");
			attr_dev(img2, "alt", "");
			if (img2.src !== (img2_src_value = "wave2.svg")) attr_dev(img2, "src", img2_src_value);
			add_location(img2, file, 159, 4, 2992);
			attr_dev(figure0, "class", "waves svelte-1jfxtu3");
			add_location(figure0, file, 157, 2, 2914);
			attr_dev(figure1, "class", "square svelte-1jfxtu3");
			add_location(figure1, file, 163, 4, 3084);
			attr_dev(img3, "alt", "");
			if (img3.src !== (img3_src_value = "./triangle.svg")) attr_dev(img3, "src", img3_src_value);
			add_location(img3, file, 165, 6, 3146);
			attr_dev(figure2, "class", "triangle svelte-1jfxtu3");
			add_location(figure2, file, 164, 4, 3114);
			attr_dev(img4, "alt", "");
			if (img4.src !== (img4_src_value = "./polygon.svg")) attr_dev(img4, "src", img4_src_value);
			add_location(img4, file, 168, 6, 3231);
			attr_dev(figure3, "class", "polygon svelte-1jfxtu3");
			add_location(figure3, file, 167, 4, 3200);
			attr_dev(div1, "class", "figure-holder svelte-1jfxtu3");
			add_location(div1, file, 162, 2, 3052);
			attr_dev(header, "class", "h-full svelte-1jfxtu3");
			add_location(header, file, 136, 0, 2244);
			attr_dev(main, "class", "px-10 py-16");
			add_location(main, file, 173, 0, 3300);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
