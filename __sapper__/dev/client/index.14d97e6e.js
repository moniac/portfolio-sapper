...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br, file, 169, 4, 3242);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(168:2) <GradientHeading depth={2}>",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img4, file, 161, 6, 3105);
			attr_dev(figure3, "class", "polygon");
			add_location(figure3, file, 160, 4, 3074);
			...
			add_location(main, file, 166, 0, 3174);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
