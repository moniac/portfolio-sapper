...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(source, file$1, 90, 6, 1651);
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p0, file$1, 74, 4, 1336);
			add_location(br0, file$1, 77, 6, 1392);
			attr_dev(h1, "class", "svelte-169thcy");
			add_location(h1, file$1, 75, 4, 1370);
			add_location(br1, file$1, 83, 6, 1512);
			add_location(p1, file$1, 81, 4, 1427);
			add_location(div0, file$1, 73, 2, 1326);
			attr_dev(div1, "class", "flex flex-col-reverse items-center justify-center lg:flex-row flex-row\n  justify-between flex-wrap");
			add_location(div1, file$1, 70, 0, 1209);
			add_location(ul, file$1, 102, 4, 1923);
			add_location(section, file$1, 101, 2, 1909);
			add_location(main, file$1, 100, 0, 1900);
		},
		m: function mount(target, anchor) {
