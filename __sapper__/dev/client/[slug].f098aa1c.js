...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(style, file, 62, 2, 1366);
			attr_dev(div0, "class", "content svelte-1i9p8at");
			add_location(div0, file, 186, 2, 3625);
			attr_dev(div1, "class", "container py-24 lg:py-24 px-4 mx-auto max-w-6xl");
			add_location(div1, file, 183, 0, 3510);
		},
		m: function mount(target, anchor) {
