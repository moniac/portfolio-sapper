...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 100, 6, 1744);
			add_location(br, file, 101, 6, 1798);
			attr_dev(h1, "class", "text-4xl");
			add_location(h1, file, 99, 4, 1716);
			attr_dev(div0, "class", "text-white");
			add_location(div0, file, 98, 2, 1687);
			attr_dev(img0, "class", "wave1 svelte-1llfw6i");
			attr_dev(img0, "alt", "");
			if (img0.src !== (img0_src_value = "wave1.svg")) attr_dev(img0, "src", img0_src_value);
			add_location(img0, file, 107, 4, 1876);
			attr_dev(img1, "class", "wave2 svelte-1llfw6i");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave2.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file, 108, 4, 1925);
			attr_dev(figure0, "class", "waves svelte-1llfw6i");
			add_location(figure0, file, 106, 2, 1849);
			attr_dev(figure1, "class", "square svelte-1llfw6i");
			add_location(figure1, file, 112, 4, 2017);
			attr_dev(div1, "class", "figure-holder svelte-1llfw6i");
			add_location(div1, file, 111, 2, 1985);
			attr_dev(header, "class", "h-full svelte-1llfw6i");
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
