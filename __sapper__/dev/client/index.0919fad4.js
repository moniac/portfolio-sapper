...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(source, file$1, 88, 6, 1571);
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p0, file$1, 72, 4, 1256);
			add_location(br0, file$1, 75, 6, 1312);
			attr_dev(h1, "class", "svelte-169thcy");
			add_location(h1, file$1, 73, 4, 1290);
			add_location(br1, file$1, 81, 6, 1432);
			add_location(p1, file$1, 79, 4, 1347);
			add_location(div0, file$1, 71, 2, 1246);
			attr_dev(div1, "class", "flex justify-between");
			add_location(div1, file$1, 70, 0, 1209);
			add_location(ul, file$1, 100, 4, 1843);
			add_location(section, file$1, 99, 2, 1829);
			add_location(main, file$1, 98, 0, 1820);
		},
		m: function mount(target, anchor) {
