...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(source, file$1, 88, 6, 1593);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(87:2) <Row flexDirection=\\\"column\\\">",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p0, file$1, 72, 4, 1278);
			add_location(br0, file$1, 75, 6, 1334);
			attr_dev(h1, "class", "svelte-169thcy");
			add_location(h1, file$1, 73, 4, 1312);
			add_location(br1, file$1, 81, 6, 1454);
			add_location(p1, file$1, 79, 4, 1369);
			add_location(div0, file$1, 71, 2, 1268);
			attr_dev(div1, "class", "flex sm:flex-col justify-between flex-wrap");
			add_location(div1, file$1, 70, 0, 1209);
			add_location(ul, file$1, 100, 4, 1865);
			add_location(section, file$1, 99, 2, 1851);
			add_location(main, file$1, 98, 0, 1842);
		},
		m: function mount(target, anchor) {
