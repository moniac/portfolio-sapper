...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 109, 6, 1869);
			add_location(br, file, 110, 6, 1923);
			attr_dev(h1, "class", "text-4xl leading-none mb-4");
			add_location(h1, file, 108, 4, 1823);
			attr_dev(p, "class", "max-w-lg");
			add_location(p, file, 113, 4, 1966);
			attr_dev(div0, "class", "px-10 intro text-white svelte-kk5o6t");
			add_location(div0, file, 107, 2, 1782);
			attr_dev(img0, "class", "wave1 svelte-kk5o6t");
			attr_dev(img0, "alt", "");
			if (img0.src !== (img0_src_value = "wave1.svg")) attr_dev(img0, "src", img0_src_value);
			add_location(img0, file, 121, 4, 2226);
			attr_dev(img1, "class", "wave2 svelte-kk5o6t");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave2.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file, 122, 4, 2275);
			attr_dev(figure0, "class", "waves svelte-kk5o6t");
			add_location(figure0, file, 120, 2, 2199);
			attr_dev(figure1, "class", "square svelte-kk5o6t");
			add_location(figure1, file, 126, 4, 2367);
			attr_dev(div1, "class", "figure-holder svelte-kk5o6t");
			add_location(div1, file, 125, 2, 2335);
			attr_dev(header, "class", "h-full svelte-kk5o6t");
			add_location(header, file, 105, 0, 1755);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
