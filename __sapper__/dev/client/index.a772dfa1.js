...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br, file, 177, 4, 3381);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(176:2) <GradientHeading depth={2}>",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img0, file, 139, 4, 2335);
			add_location(h10, file, 141, 6, 2426);
			add_location(h2, file, 142, 6, 2459);
			attr_dev(aside, "class", "text-white pl-4");
			add_location(aside, file, 140, 4, 2388);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "logo_container px-10 mt-10 svelte-138f89j");
			add_location(a, file, 138, 2, 2283);
			attr_dev(span, "class", "font-bold text-6xl");
			add_location(span, file, 147, 6, 2597);
			add_location(br, file, 148, 6, 2651);
			attr_dev(h11, "class", "text-4xl leading-none mb-4");
			add_location(h11, file, 146, 4, 2551);
			attr_dev(p, "class", "max-w-lg");
			add_location(p, file, 151, 4, 2694);
			attr_dev(div0, "class", "px-10 intro text-white svelte-138f89j");
			add_location(div0, file, 145, 2, 2510);
			attr_dev(img1, "class", "wave1 svelte-138f89j");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "g/wave1.png")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file, 159, 4, 2954);
			attr_dev(img2, "class", "wave2 svelte-138f89j");
			attr_dev(img2, "alt", "");
			if (img2.src !== (img2_src_value = "wave2.svg")) attr_dev(img2, "src", img2_src_value);
			add_location(img2, file, 160, 4, 3005);
			attr_dev(figure0, "class", "waves svelte-138f89j");
			add_location(figure0, file, 158, 2, 2927);
			attr_dev(figure1, "class", "square svelte-138f89j");
			add_location(figure1, file, 164, 4, 3097);
			attr_dev(img3, "alt", "");
			if (img3.src !== (img3_src_value = "./triangle.svg")) attr_dev(img3, "src", img3_src_value);
			add_location(img3, file, 166, 6, 3159);
			attr_dev(figure2, "class", "triangle svelte-138f89j");
			add_location(figure2, file, 165, 4, 3127);
			attr_dev(img4, "alt", "");
			if (img4.src !== (img4_src_value = "./polygon.svg")) attr_dev(img4, "src", img4_src_value);
			add_location(img4, file, 169, 6, 3244);
			attr_dev(figure3, "class", "polygon svelte-138f89j");
			add_location(figure3, file, 168, 4, 3213);
			attr_dev(div1, "class", "figure-holder svelte-138f89j");
			add_location(div1, file, 163, 2, 3065);
			attr_dev(header, "class", "h-full svelte-138f89j");
			add_location(header, file, 137, 0, 2257);
			attr_dev(main, "class", "px-10 py-16");
			add_location(main, file, 174, 0, 3313);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
