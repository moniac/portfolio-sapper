...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(source, file$1, 90, 6, 1643);
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p0, file$1, 74, 4, 1328);
			add_location(br0, file$1, 77, 6, 1384);
			attr_dev(h1, "class", "svelte-169thcy");
			add_location(h1, file$1, 75, 4, 1362);
			add_location(br1, file$1, 83, 6, 1504);
			add_location(p1, file$1, 81, 4, 1419);
			add_location(div0, file$1, 73, 2, 1318);
			attr_dev(div1, "class", "flex flex-col items-center justify-center sm:flex-row flex-row\n  justify-between flex-wrap");
			add_location(div1, file$1, 70, 0, 1209);
			add_location(ul, file$1, 102, 4, 1915);
			add_location(section, file$1, 101, 2, 1901);
			add_location(main, file$1, 100, 0, 1892);
		},
		m: function mount(target, anchor) {
