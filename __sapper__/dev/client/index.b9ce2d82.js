...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div1, "class", "flex flex-col items-center justify-center md:flex-row flex-row\n  justify-between flex-wrap");
