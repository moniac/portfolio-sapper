...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "logo_container px-10 mt-10 svelte-eyqanj");
			...
			attr_dev(figure2, "class", "triangle svelte-eyqanj");
			...
			attr_dev(figure3, "class", "polygon svelte-eyqanj");
			add_location(figure3, file, 169, 4, 3236);
			attr_dev(div1, "class", "figure-holder svelte-eyqanj");
			add_location(div1, file, 164, 2, 3088);
			attr_dev(header, "class", "h-full svelte-eyqanj");
