import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, c as create_slot, v as validate_slots, e as element, a as claim_element, b as children, f as detach_dev, g as attr_dev, h as add_location, j as insert_dev, k as get_slot_context, l as get_slot_changes, t as transition_in, m as transition_out, n as space, o as text, p as create_component, q as query_selector_all, r as claim_space, u as claim_text, w as claim_component, x as append_dev, y as mount_component, z as destroy_component } from './client.c621ff10.js';
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br, file$1, 215, 4, 4120);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img0, file$1, 177, 4, 3038);
			add_location(h10, file$1, 179, 6, 3131);
			add_location(h2, file$1, 180, 6, 3165);
			attr_dev(aside, "class", "text-white pl-4");
			add_location(aside, file$1, 178, 4, 3092);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "logo_container px-10 mt-10 svelte-1ox76uy");
			add_location(a, file$1, 176, 2, 2985);
			attr_dev(span, "class", "font-bold text-6xl");
			add_location(span, file$1, 185, 6, 3308);
			add_location(br, file$1, 186, 6, 3363);
			attr_dev(h11, "class", "text-4xl leading-none mb-4");
			add_location(h11, file$1, 184, 4, 3261);
			attr_dev(p, "class", "max-w-lg");
			add_location(p, file$1, 189, 4, 3409);
			attr_dev(div0, "class", "px-10 intro text-white svelte-1ox76uy");
			add_location(div0, file$1, 183, 2, 3219);
			attr_dev(img1, "class", "wave1 svelte-1ox76uy");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave1.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file$1, 197, 4, 3677);
			attr_dev(img2, "class", "wave2 svelte-1ox76uy");
			attr_dev(img2, "alt", "");
			if (img2.src !== (img2_src_value = "wave2.svg")) attr_dev(img2, "src", img2_src_value);
			add_location(img2, file$1, 198, 4, 3727);
			attr_dev(figure0, "class", "waves svelte-1ox76uy");
			add_location(figure0, file$1, 196, 2, 3649);
			attr_dev(figure1, "class", "square svelte-1ox76uy");
			add_location(figure1, file$1, 202, 4, 3823);
			attr_dev(img3, "alt", "");
			if (img3.src !== (img3_src_value = "./triangle.svg")) attr_dev(img3, "src", img3_src_value);
			add_location(img3, file$1, 204, 6, 3887);
			attr_dev(figure2, "class", "triangle svelte-1ox76uy");
			add_location(figure2, file$1, 203, 4, 3854);
			attr_dev(img4, "alt", "");
			if (img4.src !== (img4_src_value = "./polygon.svg")) attr_dev(img4, "src", img4_src_value);
			add_location(img4, file$1, 207, 6, 3975);
			attr_dev(figure3, "class", "polygon svelte-1ox76uy");
			add_location(figure3, file$1, 206, 4, 3943);
			attr_dev(div1, "class", "figure-holder svelte-1ox76uy");
			add_location(div1, file$1, 201, 2, 3790);
			attr_dev(header, "class", "h-full svelte-1ox76uy");
			add_location(header, file$1, 175, 0, 2958);
			attr_dev(main, "class", "px-10 py-16");
			add_location(main, file$1, 212, 0, 4049);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
