...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br, file, 148, 4, 2802);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h10, file, 118, 6, 2017);
			add_location(h2, file, 119, 6, 2050);
