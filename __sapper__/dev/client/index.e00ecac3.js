...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 103, 6, 1781);
			add_location(br, file, 104, 6, 1835);
			attr_dev(h1, "class", "text-4xl");
			add_location(h1, file, 102, 4, 1753);
			attr_dev(div0, "class", "text-white");
			add_location(div0, file, 101, 2, 1724);
			attr_dev(img0, "class", "wave1 svelte-141rukf");
			attr_dev(img0, "alt", "");
			if (img0.src !== (img0_src_value = "wave1.svg")) attr_dev(img0, "src", img0_src_value);
			add_location(img0, file, 110, 4, 1913);
			attr_dev(img1, "class", "wave2 svelte-141rukf");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave2.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file, 111, 4, 1962);
			attr_dev(figure0, "class", "waves svelte-141rukf");
			add_location(figure0, file, 109, 2, 1886);
			attr_dev(figure1, "class", "square svelte-141rukf");
			add_location(figure1, file, 115, 4, 2054);
			attr_dev(div1, "class", "figure-holder svelte-141rukf");
			add_location(div1, file, 114, 2, 2022);
			attr_dev(header, "class", "h-full svelte-141rukf");
			add_location(header, file, 99, 0, 1697);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
