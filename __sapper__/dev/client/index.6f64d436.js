...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 105, 6, 1834);
			add_location(br, file, 106, 6, 1888);
			attr_dev(h1, "class", "text-4xl leading-none");
			add_location(h1, file, 104, 4, 1793);
			attr_dev(p, "class", "max-w-lg");
			add_location(p, file, 109, 4, 1931);
			attr_dev(div0, "class", "px-10 intro text-white svelte-dwrw9b");
			add_location(div0, file, 103, 2, 1752);
			attr_dev(img0, "class", "wave1 svelte-dwrw9b");
			attr_dev(img0, "alt", "");
			if (img0.src !== (img0_src_value = "wave1.svg")) attr_dev(img0, "src", img0_src_value);
			add_location(img0, file, 117, 4, 2191);
			attr_dev(img1, "class", "wave2 svelte-dwrw9b");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave2.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file, 118, 4, 2240);
			attr_dev(figure0, "class", "waves svelte-dwrw9b");
			add_location(figure0, file, 116, 2, 2164);
			attr_dev(figure1, "class", "square svelte-dwrw9b");
			add_location(figure1, file, 122, 4, 2332);
			attr_dev(div1, "class", "figure-holder svelte-dwrw9b");
			add_location(div1, file, 121, 2, 2300);
			attr_dev(header, "class", "h-full svelte-dwrw9b");
			add_location(header, file, 101, 0, 1725);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
