...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 101, 6, 1718);
			add_location(br, file, 102, 6, 1772);
			attr_dev(h1, "class", "text-4xl");
			add_location(h1, file, 100, 4, 1690);
			attr_dev(div0, "class", "text-white");
			add_location(div0, file, 99, 2, 1661);
			attr_dev(img0, "class", "wave1 svelte-f00i8g");
			attr_dev(img0, "alt", "");
			if (img0.src !== (img0_src_value = "wave1.svg")) attr_dev(img0, "src", img0_src_value);
			add_location(img0, file, 108, 4, 1850);
			attr_dev(img1, "class", "wave2 svelte-f00i8g");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave2.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file, 109, 4, 1899);
			attr_dev(figure0, "class", "waves svelte-f00i8g");
			add_location(figure0, file, 107, 2, 1823);
			attr_dev(figure1, "class", "square svelte-f00i8g");
			add_location(figure1, file, 113, 4, 1991);
			attr_dev(div1, "class", "figure-holder svelte-f00i8g");
			add_location(div1, file, 112, 2, 1959);
			attr_dev(header, "class", "h-full svelte-f00i8g");
			add_location(header, file, 97, 0, 1634);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
