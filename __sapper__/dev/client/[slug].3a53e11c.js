...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(style, file, 66, 2, 1452);
			attr_dev(div0, "class", "content svelte-fvwkvm");
			add_location(div0, file, 190, 2, 3711);
			attr_dev(div1, "class", "container py-24 lg:py-24 px-4 mx-auto max-w-6xl");
			add_location(div1, file, 187, 0, 3596);
		},
		m: function mount(target, anchor) {
