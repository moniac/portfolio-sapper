import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, c as create_slot, v as validate_slots, e as element, a as claim_element, b as children, f as detach_dev, g as attr_dev, h as add_location, j as insert_dev, k as get_slot_context, l as get_slot_changes, t as transition_in, m as transition_out, n as space, o as text, p as create_component, q as query_selector_all, r as claim_space, u as claim_text, w as claim_component, x as append_dev, y as mount_component, z as destroy_component } from './client.703517da.js';
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br, file$1, 203, 4, 3877);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img0, file$1, 165, 4, 2795);
			add_location(h10, file$1, 167, 6, 2888);
			add_location(h2, file$1, 168, 6, 2922);
			attr_dev(aside, "class", "text-white pl-4");
			add_location(aside, file$1, 166, 4, 2849);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "logo_container px-10 mt-10 svelte-7rby0j");
			add_location(a, file$1, 164, 2, 2742);
			attr_dev(span, "class", "font-bold text-6xl");
			add_location(span, file$1, 173, 6, 3065);
			add_location(br, file$1, 174, 6, 3120);
			attr_dev(h11, "class", "text-4xl leading-none mb-4");
			add_location(h11, file$1, 172, 4, 3018);
			attr_dev(p, "class", "max-w-lg");
			add_location(p, file$1, 177, 4, 3166);
			attr_dev(div0, "class", "px-10 intro text-white svelte-7rby0j");
			add_location(div0, file$1, 171, 2, 2976);
			attr_dev(img1, "class", "wave1 svelte-7rby0j");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave1.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file$1, 185, 4, 3434);
			attr_dev(img2, "class", "wave2 svelte-7rby0j");
			attr_dev(img2, "alt", "");
			if (img2.src !== (img2_src_value = "wave2.svg")) attr_dev(img2, "src", img2_src_value);
			add_location(img2, file$1, 186, 4, 3484);
			attr_dev(figure0, "class", "waves svelte-7rby0j");
			add_location(figure0, file$1, 184, 2, 3406);
			attr_dev(figure1, "class", "square svelte-7rby0j");
			add_location(figure1, file$1, 190, 4, 3580);
			attr_dev(img3, "alt", "");
			if (img3.src !== (img3_src_value = "./triangle.svg")) attr_dev(img3, "src", img3_src_value);
			add_location(img3, file$1, 192, 6, 3644);
			attr_dev(figure2, "class", "triangle svelte-7rby0j");
			add_location(figure2, file$1, 191, 4, 3611);
			attr_dev(img4, "alt", "");
			if (img4.src !== (img4_src_value = "./polygon.svg")) attr_dev(img4, "src", img4_src_value);
			add_location(img4, file$1, 195, 6, 3732);
			attr_dev(figure3, "class", "polygon svelte-7rby0j");
			add_location(figure3, file$1, 194, 4, 3700);
			attr_dev(div1, "class", "figure-holder svelte-7rby0j");
			add_location(div1, file$1, 189, 2, 3547);
			attr_dev(header, "class", "h-full svelte-7rby0j");
			add_location(header, file$1, 163, 0, 2715);
			attr_dev(main, "class", "px-10 py-16");
			add_location(main, file$1, 200, 0, 3806);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
