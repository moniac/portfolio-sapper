...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 100, 6, 1750);
			add_location(br, file, 101, 6, 1804);
			attr_dev(h1, "class", "text-4xl");
			add_location(h1, file, 99, 4, 1722);
			attr_dev(div0, "class", "intro text-white");
			add_location(div0, file, 98, 2, 1687);
			attr_dev(img0, "class", "wave1 svelte-glbjjk");
			attr_dev(img0, "alt", "");
			if (img0.src !== (img0_src_value = "wave1.svg")) attr_dev(img0, "src", img0_src_value);
			add_location(img0, file, 107, 4, 1882);
			attr_dev(img1, "class", "wave2 svelte-glbjjk");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave2.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file, 108, 4, 1931);
			attr_dev(figure0, "class", "waves svelte-glbjjk");
			add_location(figure0, file, 106, 2, 1855);
			attr_dev(figure1, "class", "square svelte-glbjjk");
			add_location(figure1, file, 112, 4, 2023);
			attr_dev(div1, "class", "figure-holder svelte-glbjjk");
			add_location(div1, file, 111, 2, 1991);
			attr_dev(header, "class", "h-full svelte-glbjjk");
			add_location(header, file, 96, 0, 1660);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
