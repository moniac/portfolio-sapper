import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, c as create_slot, v as validate_slots, e as element, a as claim_element, b as children, f as detach_dev, g as attr_dev, h as add_location, j as insert_dev, k as get_slot_context, l as get_slot_changes, t as transition_in, m as transition_out, n as space, o as text, p as create_component, q as query_selector_all, r as claim_space, u as claim_text, w as claim_component, x as append_dev, y as mount_component, z as destroy_component } from './client.14d1882a.js';
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(br, "class", "svelte-1trpehl");
			add_location(br, file$1, 257, 4, 4786);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img0, "class", "svelte-1trpehl");
			add_location(img0, file$1, 217, 4, 3621);
			attr_dev(h10, "class", "svelte-1trpehl");
			add_location(h10, file$1, 219, 6, 3714);
			attr_dev(h2, "class", "svelte-1trpehl");
			add_location(h2, file$1, 220, 6, 3748);
			attr_dev(aside, "class", "text-white pl-4 svelte-1trpehl");
			add_location(aside, file$1, 218, 4, 3675);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "logo_container px-10 mt-10 svelte-1trpehl");
			add_location(a, file$1, 216, 2, 3568);
			attr_dev(span, "class", "font-bold text-6xl svelte-1trpehl");
			add_location(span, file$1, 227, 8, 3930);
			attr_dev(br, "class", "svelte-1trpehl");
			add_location(br, file$1, 228, 8, 3987);
			attr_dev(h11, "class", "text-4xl leading-none mb-4 svelte-1trpehl");
			add_location(h11, file$1, 226, 6, 3881);
			attr_dev(p, "class", "max-w-lg svelte-1trpehl");
			add_location(p, file$1, 231, 6, 4039);
			attr_dev(div0, "class", "px-10 intro text-white svelte-1trpehl");
			add_location(div0, file$1, 225, 4, 3837);
			attr_dev(figure0, "class", "square svelte-1trpehl");
			add_location(figure0, file$1, 239, 6, 4326);
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "./triangle.svg")) attr_dev(img1, "src", img1_src_value);
			attr_dev(img1, "class", "svelte-1trpehl");
			add_location(img1, file$1, 241, 8, 4394);
			attr_dev(figure1, "class", "triangle svelte-1trpehl");
			add_location(figure1, file$1, 240, 6, 4359);
			attr_dev(img2, "alt", "");
			if (img2.src !== (img2_src_value = "./polygon.svg")) attr_dev(img2, "src", img2_src_value);
			attr_dev(img2, "class", "svelte-1trpehl");
			add_location(img2, file$1, 244, 8, 4488);
			attr_dev(figure2, "class", "polygon svelte-1trpehl");
			add_location(figure2, file$1, 243, 6, 4454);
			attr_dev(div1, "class", "figure-holder svelte-1trpehl");
			add_location(div1, file$1, 238, 4, 4291);
			attr_dev(div2, "class", "header-holder svelte-1trpehl");
			add_location(div2, file$1, 224, 2, 3804);
			attr_dev(img3, "class", "wave1 svelte-1trpehl");
			attr_dev(img3, "alt", "");
			if (img3.src !== (img3_src_value = "wave1.svg")) attr_dev(img3, "src", img3_src_value);
			add_location(img3, file$1, 249, 4, 4593);
			attr_dev(img4, "class", "wave2 svelte-1trpehl");
			attr_dev(img4, "alt", "");
			if (img4.src !== (img4_src_value = "wave2.svg")) attr_dev(img4, "src", img4_src_value);
			add_location(img4, file$1, 250, 4, 4643);
			attr_dev(figure3, "class", "waves svelte-1trpehl");
			add_location(figure3, file$1, 248, 2, 4565);
			attr_dev(header, "class", "h-full svelte-1trpehl");
			add_location(header, file$1, 215, 0, 3541);
			attr_dev(main, "class", "px-10 py-16 svelte-1trpehl");
			add_location(main, file$1, 254, 0, 4715);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
