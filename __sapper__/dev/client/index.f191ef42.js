import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, c as create_slot, v as validate_slots, e as element, a as claim_element, b as children, f as detach_dev, g as attr_dev, h as add_location, j as insert_dev, k as get_slot_context, l as get_slot_changes, t as transition_in, m as transition_out, n as space, o as text, p as create_component, q as query_selector_all, r as claim_space, u as claim_text, w as claim_component, x as append_dev, y as mount_component, z as destroy_component } from './client.6e562227.js';
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br, file$1, 204, 4, 3923);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img0, file$1, 166, 4, 2841);
			add_location(h10, file$1, 168, 6, 2934);
			add_location(h2, file$1, 169, 6, 2968);
			attr_dev(aside, "class", "text-white pl-4");
			add_location(aside, file$1, 167, 4, 2895);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "logo_container px-10 mt-10 svelte-1fruxj5");
			add_location(a, file$1, 165, 2, 2788);
			attr_dev(span, "class", "font-bold text-6xl");
			add_location(span, file$1, 174, 6, 3111);
			add_location(br, file$1, 175, 6, 3166);
			attr_dev(h11, "class", "text-4xl leading-none mb-4");
			add_location(h11, file$1, 173, 4, 3064);
			attr_dev(p, "class", "max-w-lg");
			add_location(p, file$1, 178, 4, 3212);
			attr_dev(div0, "class", "px-10 intro text-white svelte-1fruxj5");
			add_location(div0, file$1, 172, 2, 3022);
			attr_dev(img1, "class", "wave1 svelte-1fruxj5");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave1.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file$1, 186, 4, 3480);
			attr_dev(img2, "class", "wave2 svelte-1fruxj5");
			attr_dev(img2, "alt", "");
			if (img2.src !== (img2_src_value = "wave2.svg")) attr_dev(img2, "src", img2_src_value);
			add_location(img2, file$1, 187, 4, 3530);
			attr_dev(figure0, "class", "waves svelte-1fruxj5");
			add_location(figure0, file$1, 185, 2, 3452);
			attr_dev(figure1, "class", "square svelte-1fruxj5");
			add_location(figure1, file$1, 191, 4, 3626);
			attr_dev(img3, "alt", "");
			if (img3.src !== (img3_src_value = "./triangle.svg")) attr_dev(img3, "src", img3_src_value);
			add_location(img3, file$1, 193, 6, 3690);
			attr_dev(figure2, "class", "triangle svelte-1fruxj5");
			add_location(figure2, file$1, 192, 4, 3657);
			attr_dev(img4, "alt", "");
			if (img4.src !== (img4_src_value = "./polygon.svg")) attr_dev(img4, "src", img4_src_value);
			add_location(img4, file$1, 196, 6, 3778);
			attr_dev(figure3, "class", "polygon svelte-1fruxj5");
			add_location(figure3, file$1, 195, 4, 3746);
			attr_dev(div1, "class", "figure-holder svelte-1fruxj5");
			add_location(div1, file$1, 190, 2, 3593);
			attr_dev(header, "class", "h-full svelte-1fruxj5");
			add_location(header, file$1, 164, 0, 2761);
			attr_dev(main, "class", "px-10 py-16");
			add_location(main, file$1, 201, 0, 3852);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
