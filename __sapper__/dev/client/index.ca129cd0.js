...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 42, 8, 906);
			attr_dev(summary, "class", "italic");
			add_location(summary, file, 45, 8, 1011);
			add_location(li, file, 41, 6, 893);
		},
		m: function mount(target, anchor) {
