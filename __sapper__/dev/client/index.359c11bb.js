...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 103, 6, 1772);
			add_location(br, file, 104, 6, 1826);
			attr_dev(h1, "class", "text-4xl");
			add_location(h1, file, 102, 4, 1744);
			attr_dev(div0, "class", "text-white");
			add_location(div0, file, 101, 2, 1715);
			attr_dev(img0, "class", "wave1 svelte-kdjwsp");
			attr_dev(img0, "alt", "");
			if (img0.src !== (img0_src_value = "wave1.svg")) attr_dev(img0, "src", img0_src_value);
			add_location(img0, file, 110, 4, 1904);
			attr_dev(img1, "class", "wave2 svelte-kdjwsp");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave2.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file, 111, 4, 1953);
			attr_dev(figure0, "class", "waves svelte-kdjwsp");
			add_location(figure0, file, 109, 2, 1877);
			attr_dev(figure1, "class", "square svelte-kdjwsp");
			add_location(figure1, file, 115, 4, 2045);
			attr_dev(div1, "class", "figure-holder svelte-kdjwsp");
			add_location(div1, file, 114, 2, 2013);
			attr_dev(header, "class", "h-full svelte-kdjwsp");
			add_location(header, file, 99, 0, 1688);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
