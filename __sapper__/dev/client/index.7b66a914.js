...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br, file, 175, 4, 3351);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img0, file, 137, 4, 2305);
			add_location(h10, file, 139, 6, 2396);
			add_location(h2, file, 140, 6, 2429);
			attr_dev(aside, "class", "text-white pl-4");
			add_location(aside, file, 138, 4, 2358);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "logo_container px-10 mt-10 svelte-ja94g1");
			add_location(a, file, 136, 2, 2253);
			attr_dev(span, "class", "font-bold text-6xl");
			add_location(span, file, 145, 6, 2567);
			add_location(br, file, 146, 6, 2621);
			attr_dev(h11, "class", "text-4xl leading-none mb-4");
			add_location(h11, file, 144, 4, 2521);
			attr_dev(p, "class", "max-w-lg");
			add_location(p, file, 149, 4, 2664);
			attr_dev(div0, "class", "px-10 intro text-white svelte-ja94g1");
			add_location(div0, file, 143, 2, 2480);
			attr_dev(img1, "class", "wave1 svelte-ja94g1");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "g/wave1.png")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file, 157, 4, 2924);
			attr_dev(img2, "class", "wave2 svelte-ja94g1");
			attr_dev(img2, "alt", "");
			if (img2.src !== (img2_src_value = "wave2.svg")) attr_dev(img2, "src", img2_src_value);
			add_location(img2, file, 158, 4, 2975);
			attr_dev(figure0, "class", "waves svelte-ja94g1");
			add_location(figure0, file, 156, 2, 2897);
			attr_dev(figure1, "class", "square svelte-ja94g1");
			add_location(figure1, file, 162, 4, 3067);
			attr_dev(img3, "alt", "");
			if (img3.src !== (img3_src_value = "./triangle.svg")) attr_dev(img3, "src", img3_src_value);
			add_location(img3, file, 164, 6, 3129);
			attr_dev(figure2, "class", "triangle svelte-ja94g1");
			add_location(figure2, file, 163, 4, 3097);
			attr_dev(img4, "alt", "");
			if (img4.src !== (img4_src_value = "./polygon.svg")) attr_dev(img4, "src", img4_src_value);
			add_location(img4, file, 167, 6, 3214);
			attr_dev(figure3, "class", "polygon svelte-ja94g1");
			add_location(figure3, file, 166, 4, 3183);
			attr_dev(div1, "class", "figure-holder svelte-ja94g1");
			add_location(div1, file, 161, 2, 3035);
			attr_dev(header, "class", "h-full svelte-ja94g1");
			add_location(header, file, 135, 0, 2227);
			attr_dev(main, "class", "px-10 py-16");
			add_location(main, file, 172, 0, 3283);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
