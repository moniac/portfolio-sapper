...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 110, 6, 1896);
			add_location(br, file, 111, 6, 1950);
			attr_dev(h1, "class", "text-4xl leading-none mb-4");
			add_location(h1, file, 109, 4, 1850);
			attr_dev(p, "class", "max-w-lg");
			add_location(p, file, 114, 4, 1993);
			attr_dev(div0, "class", "px-10 intro text-white svelte-17uu2h4");
			add_location(div0, file, 108, 2, 1809);
			attr_dev(img0, "class", "wave1 svelte-17uu2h4");
			attr_dev(img0, "alt", "");
			if (img0.src !== (img0_src_value = "wave1.svg")) attr_dev(img0, "src", img0_src_value);
			add_location(img0, file, 122, 4, 2253);
			attr_dev(img1, "class", "wave2 svelte-17uu2h4");
			attr_dev(img1, "alt", "");
			if (img1.src !== (img1_src_value = "wave2.svg")) attr_dev(img1, "src", img1_src_value);
			add_location(img1, file, 123, 4, 2302);
			attr_dev(figure0, "class", "waves svelte-17uu2h4");
			add_location(figure0, file, 121, 2, 2226);
			attr_dev(figure1, "class", "square svelte-17uu2h4");
			add_location(figure1, file, 127, 4, 2394);
			attr_dev(div1, "class", "figure-holder svelte-17uu2h4");
			add_location(div1, file, 126, 2, 2362);
			attr_dev(header, "class", "h-full svelte-17uu2h4");
			add_location(header, file, 106, 0, 1782);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
